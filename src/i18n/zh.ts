...
export const zh: Content = {
  ...
  cases: [
    ...
    },
    {
      ...
      excerpt:
        'I-Nodal 节点地震采集系统完成大规模工业化生产与中石化主力探区规模化应用，实现国产陆上地震采集装备零的突破。',
      ...
      body: [
        ...
        'I-Nodal节点地震采集系统的成功研制与规模应用标志了具有完全自主知识产权的国产陆上地震采集装备实现零的突破。2021年5月，中国石化报以“节点技术引领地震采集新模式”为题对I-Nodal节点的技术与应用做了主题整版报道，向建党100周年献礼。2021年底，在国家能源局、科技部共同编制印发的《十四五能源领域科技创新规划》中，提出了 “2025年实现百万道级全数字地震探测和深海智能化节点稳定可靠采集，完成智能高精度可控震源技术推广应用”的国家油气安全保障供应技术路线图。以此为目标，中科深源科技有限公司技术团队正以饱满的热情投入到新一代I-Nodal节点地震采集系统的研发工作中。团队秉承“求真务实 知行合一”的宗旨，全力协助中石化石油工程地球物理有限公司切实推进石油石化重大技术装备国产化，以科技创新加快推进资源规模化开发，高质量端好能源的饭碗。',
      ],
    },
  ],
